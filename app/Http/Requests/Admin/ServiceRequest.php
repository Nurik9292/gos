...
class ServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tm_content' => ['required', 'string', 'max:300'],
            'ru_content' => ['required', 'string', 'max:300'],
            'en_content' => ['required', 'string', 'max:300'],
        ];
    }
    ...
    public function messages(): array
    {
        return[
            ...
            'ru_content.max' => 'Максимальное количество символов 300',
            'en_content.required' => 'Заполните поле',
            'en_content.max' => 'Максимальное количество символов 300',
            'tm_content.required' => 'Заполните поле',
            'tm_content.max' => 'Максимальное количество символов 300',
        ];
    }
}
